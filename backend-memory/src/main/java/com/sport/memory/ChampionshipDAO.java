 ...
 * @author krisztian
 */
public class ChampionshipDAO implements com.sport.faces.ChampionshipDAO {
    private static final Logger LOGG = Logger.getLogger(ChampionshipDAO.class.getName());
