...
import com.sport.memory.ChampionshipDAO;
import com.sport.memory.CompetitionDAO;
import com.sport.memory.CompetitorDAO;
import com.sport.memory.RaceDAO;
import com.sport.memory.SeasonDAO;
import com.sport.memory.SeriesDAO;
import com.sport.memory.SportTypeDAO;
...
public class MemoryFactory implements AbstractFactory{
    ...
    private final com.sport.faces.SportTypeDAO sportTypeDAO = new SportTypeDAO();
    private final com.sport.faces.SeasonDAO seasonDAO = new SeasonDAO();
    private final com.sport.faces.ChampionshipDAO championshipDAO = new ChampionshipDAO();
    private final com.sport.faces.CompetitionDAO competitionDAO = new CompetitionDAO();
    private final com.sport.faces.CompetitorDAO competitorDAO = new CompetitorDAO();
    private final com.sport.faces.RaceDAO raceDAO = new RaceDAO();
    private final com.sport.faces.SeriesDAO seriesDAO = new SeriesDAO();
